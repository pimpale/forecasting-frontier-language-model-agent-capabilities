...
from bash_minimal.commands.BaseCommand import BaseCommand, CommandOutput
    ...
    async def _run(self, content: str) -> CommandOutput:
        if content != "":
            return CommandOutput(
                "ERROR: The browse command does not take any arguments."
            )

        return CommandOutput("""To browse the web, use the `browse-*` family of commands wrapped in the <bash></bash> XML tags.
